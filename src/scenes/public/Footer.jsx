        ...
        <div className='px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl'>
          <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12'>
            <div className='col-span-2 md:col-span-4 xl:pr-8'>
              ...
              <p className=' text-xs leading-relaxed text-white mt-7'>
                An AI based WealthTech startup that aims to revolutionize the
                wealth management industry.Innovative technology to offer
                digital solutions to facilitate the process of wealth
                management.
              </p>
              <Link
                to='https://play.google.com/store/apps/details?id=com.navya'
                className=' mt-2 p-1 block transition-all duration-200 hover:opacity-80 focus:opacity-80'
              >
                <img
                  className='w-auto rounded h-12 sm:h-12 outline'
              ...
              {/* <a
								href='#'
								title=''
								className='inline-flex items-center justify-center px-6 py-4 font-semibold text-white transition-all duration-200 bg-white rounded-md hover:bg-blue-700 focus:bg-blue-700 mt-7'
							>
								<svg
									className='w-6 h-6'
          ...
          <div className='sm:flex sm:items-center sm:justify-between'>
            <p className='text-sm text-gray-100'>
              © Copyright 2023, All Rights Reserved by NAVYA ADVISORS
            </p>
